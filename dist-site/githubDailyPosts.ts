...
export const githubDailyPosts: BlogPost[] = [
  {
    id: 'github-daily-2026-05-16',
    title: `今日值得看的 10 个 GitHub 开源项目｜2026-05-16`,
    summary: `白鹿 io 每日开源观察：带个人判断、项目地址、多语言速览，筛选值得关注的 AI 工具、效率工具和学习资源。`,
    content: `# 今日值得看的 10 个 GitHub 开源项目｜2026-05-16<br/>
<br/>
...
- 适合人群：适合想提升工作效率、做内容、写代码或研究 AI 应用的人。<br/>
<br/>
### 9. [fffaraz/awesome-cpp](https://github.com/fffaraz/awesome-cpp)<br/>
<br/>
...
| 7 | [lobehub/lobehub](https://github.com/lobehub/lobehub) | AI Tools | The ultimate space for work and life — to find, build, and collaborate with agent teammate... | My take: worth tracking because it may improve writing, coding, research, or automation workflows. |<br/>
...
| 9 | [fffaraz/awesome-cpp](https://github.com/fffaraz/awesome-cpp) | Learning | A curated list of awesome C++ (or C) frameworks, libraries, resources, and shiny things. I... | My take: a good project to bookmark and revisit when learning or building a roadmap. |<br/>
...
| 7 | [lobehub/lobehub](https://github.com/lobehub/lobehub) | AIツール | The ultimate space for work and life — to find, build, and collaborate with agent teammate... | 所感：文章作成、開発、調査、自動化の効率を上げる可能性があり、継続的に見たいプロジェクトです。 |<br/>
...
| 9 | [fffaraz/awesome-cpp](https://github.com/fffaraz/awesome-cpp) | 学習リソース | A curated list of awesome C++ (or C) frameworks, libraries, resources, and shiny things. I... | 所感：学習ロードマップや資料集として保存しておきたいプロジェクトです。 |<br/>
...
| 7 | [lobehub/lobehub](https://github.com/lobehub/lobehub) | AI 도구 | The ultimate space for work and life — to find, build, and collaborate with agent teammate... | 의견: 글쓰기, 개발, 리서치, 자동화 효율을 높일 수 있어 계속 지켜볼 만합니다. |<br/>
...
| 9 | [fffaraz/awesome-cpp](https://github.com/fffaraz/awesome-cpp) | 학습 자료 | A curated list of awesome C++ (or C) frameworks, libraries, resources, and shiny things. I... | 의견: 학습 자료나 로드맵으로 저장해두기 좋습니다. |<br/>
