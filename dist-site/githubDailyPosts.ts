...
export const githubDailyPosts: BlogPost[] = [
  {
    id: 'github-daily-2026-05-31',
    title: `今日值得看的 10 个 GitHub 开源项目｜2026-05-31`,
    summary: `白鹿 io 每日开源观察：带个人判断、项目地址、多语言速览，筛选值得关注的 AI 工具、效率工具和学习资源。`,
    content: `# 今日值得看的 10 个 GitHub 开源项目｜2026-05-31<br/>
<br/>
...
| 7 | [code-yeongyu/oh-my-openagent](https://github.com/code-yeongyu/oh-my-openagent) | AI Tools | omo; the best agent harness - previously oh-my-opencode | My take: worth tracking because it may improve writing, coding, research, or automation workflows. |<br/>
| 8 | [nexu-io/open-design](https://github.com/nexu-io/open-design) | AI Tools | 🎨 Local-first, open-source Claude Design alternative. 🖥️ Native desktop app. ⚡ 259+ Skills... | My take: worth tracking because it may improve writing, coding, research, or automation workflows. |<br/>
...
| 7 | [code-yeongyu/oh-my-openagent](https://github.com/code-yeongyu/oh-my-openagent) | AIツール | omo; the best agent harness - previously oh-my-opencode | 所感：文章作成、開発、調査、自動化の効率を上げる可能性があり、継続的に見たいプロジェクトです。 |<br/>
| 8 | [nexu-io/open-design](https://github.com/nexu-io/open-design) | AIツール | 🎨 Local-first, open-source Claude Design alternative. 🖥️ Native desktop app. ⚡ 259+ Skills... | 所感：文章作成、開発、調査、自動化の効率を上げる可能性があり、継続的に見たいプロジェクトです。 |<br/>
...
| 7 | [code-yeongyu/oh-my-openagent](https://github.com/code-yeongyu/oh-my-openagent) | AI 도구 | omo; the best agent harness - previously oh-my-opencode | 의견: 글쓰기, 개발, 리서치, 자동화 효율을 높일 수 있어 계속 지켜볼 만합니다. |<br/>
| 8 | [nexu-io/open-design](https://github.com/nexu-io/open-design) | AI 도구 | 🎨 Local-first, open-source Claude Design alternative. 🖥️ Native desktop app. ⚡ 259+ Skills... | 의견: 글쓰기, 개발, 리서치, 자동화 효율을 높일 수 있어 계속 지켜볼 만합니다. |<br/>
