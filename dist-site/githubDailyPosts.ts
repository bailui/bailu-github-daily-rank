...
export const githubDailyPosts: BlogPost[] = [
  {
    id: 'github-daily-2026-09-09',
    title: `今日值得看的 10 个 GitHub 开源项目｜2026-09-09`,
    summary: `白鹿 io 每日开源观察：带个人判断、项目地址、多语言速览，筛选值得关注的 AI 工具、效率工具和学习资源。`,
    content: `# 今日值得看的 10 个 GitHub 开源项目｜2026-09-09<br/>
<br/>
...
- 适合人群：适合想提升工作效率、做内容、写代码或研究 AI 应用的人。<br/>
<br/>
### 9. [router-for-me/CLIProxyAPI](https://github.com/router-for-me/CLIProxyAPI)<br/>
<br/>
- 地址：[https://github.com/router-for-me/CLIProxyAPI](https://github.com/router-for-me/CLIProxyAPI)<br/>
- 分类：AI工具<br/>
- 语言：Go<br/>
- Stars：51,046<br/>
- 一句话：Wrap Antigravity, ChatGPT Codex, Claude Code, Grok Build as an OpenAI/Gemini/Claude/Codex compatible API service, allowing you to enjoy the free Gemini 3.1 Pro,...<br/>
- 我的判断：我会优先关注这类项目，它可能直接改变写作、编程、整理资料和自动化工作的效率。<br/>
- 适合人群：适合想提升工作效率、做内容、写代码或研究 AI 应用的人。<br/>
<br/>
...
| 9 | [router-for-me/CLIProxyAPI](https://github.com/router-for-me/CLIProxyAPI) | AI Tools | Wrap Antigravity, ChatGPT Codex, Claude Code, Grok Build as an OpenAI/Gemini/Claude/Codex ... | My take: worth tracking because it may improve writing, coding, research, or automation workflows. |<br/>
...
| 9 | [router-for-me/CLIProxyAPI](https://github.com/router-for-me/CLIProxyAPI) | AIツール | Wrap Antigravity, ChatGPT Codex, Claude Code, Grok Build as an OpenAI/Gemini/Claude/Codex ... | 所感：文章作成、開発、調査、自動化の効率を上げる可能性があり、継続的に見たいプロジェクトです。 |<br/>
...
| 9 | [router-for-me/CLIProxyAPI](https://github.com/router-for-me/CLIProxyAPI) | AI 도구 | Wrap Antigravity, ChatGPT Codex, Claude Code, Grok Build as an OpenAI/Gemini/Claude/Codex ... | 의견: 글쓰기, 개발, 리서치, 자동화 효율을 높일 수 있어 계속 지켜볼 만합니다. |<br/>
