...
export const githubDailyPosts: BlogPost[] = [
  {
    id: 'github-daily-2026-08-23',
    title: `今日值得看的 10 个 GitHub 开源项目｜2026-08-23`,
    summary: `白鹿 io 每日开源观察：带个人判断、项目地址、多语言速览，筛选值得关注的 AI 工具、效率工具和学习资源。`,
    content: `# 今日值得看的 10 个 GitHub 开源项目｜2026-08-23<br/>
<br/>
...
- [excalidraw/excalidraw](https://github.com/excalidraw/excalidraw)：这类项目值得放进日常工作流里观察，实用性通常比较强。<br/>
<br/>
...
- **[excalidraw/excalidraw](https://github.com/excalidraw/excalidraw)**：这类项目值得放进日常工作流里观察，实用性通常比较强。  <br/>
  - 看点：Virtual whiteboard for sketching hand-drawn like diagrams<br/>
<br/>
## 今日榜单<br/>
<br/>
...
- 适合人群：适合想提升工作效率、做内容、写代码或研究 AI 应用的人。<br/>
<br/>
### 3. [excalidraw/excalidraw](https://github.com/excalidraw/excalidraw)<br/>
<br/>
...
- 适合人群：适合想提升工作效率、做内容、写代码或研究 AI 应用的人。<br/>
<br/>
### 9. [tw93/Pake](https://github.com/tw93/Pake)<br/>
<br/>
...
| 3 | [excalidraw/excalidraw](https://github.com/excalidraw/excalidraw) | Productivity | Virtual whiteboard for sketching hand-drawn like diagrams | My take: this could become part of a practical daily productivity workflow. |<br/>
...
| 9 | [tw93/Pake](https://github.com/tw93/Pake) | AI Tools | 🤱🏻 Turn any webpage into a desktop app with one command. | My take: worth tracking because it may improve writing, coding, research, or automation workflows. |<br/>
...
| 3 | [excalidraw/excalidraw](https://github.com/excalidraw/excalidraw) | 生産性ツール | Virtual whiteboard for sketching hand-drawn like diagrams | 所感：日々の作業フローに入れられる可能性がある実用系ツールです。 |<br/>
...
| 9 | [tw93/Pake](https://github.com/tw93/Pake) | AIツール | 🤱🏻 Turn any webpage into a desktop app with one command. | 所感：文章作成、開発、調査、自動化の効率を上げる可能性があり、継続的に見たいプロジェクトです。 |<br/>
...
| 3 | [excalidraw/excalidraw](https://github.com/excalidraw/excalidraw) | 생산성 도구 | Virtual whiteboard for sketching hand-drawn like diagrams | 의견: 일상 업무 흐름에 넣어볼 만한 실용 도구입니다. |<br/>
...
| 9 | [tw93/Pake](https://github.com/tw93/Pake) | AI 도구 | 🤱🏻 Turn any webpage into a desktop app with one command. | 의견: 글쓰기, 개발, 리서치, 자동화 효율을 높일 수 있어 계속 지켜볼 만합니다. |<br/>
