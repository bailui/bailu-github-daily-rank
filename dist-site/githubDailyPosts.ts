...
export const githubDailyPosts: BlogPost[] = [
  {
    id: 'github-daily-2026-08-29',
    title: `今日值得看的 10 个 GitHub 开源项目｜2026-08-29`,
    summary: `白鹿 io 每日开源观察：带个人判断、项目地址、多语言速览，筛选值得关注的 AI 工具、效率工具和学习资源。`,
    content: `# 今日值得看的 10 个 GitHub 开源项目｜2026-08-29<br/>
<br/>
...
<br/>
### 6. [hacksider/Deep-Live-Cam](https://github.com/hacksider/Deep-Live-Cam)<br/>
<br/>
...
| 6 | [hacksider/Deep-Live-Cam](https://github.com/hacksider/Deep-Live-Cam) | AI Tools | real time face swap and one-click video deepfake with only a single image | My take: worth tracking because it may improve writing, coding, research, or automation workflows. |<br/>
...
| 6 | [hacksider/Deep-Live-Cam](https://github.com/hacksider/Deep-Live-Cam) | AIツール | real time face swap and one-click video deepfake with only a single image | 所感：文章作成、開発、調査、自動化の効率を上げる可能性があり、継続的に見たいプロジェクトです。 |<br/>
...
| 6 | [hacksider/Deep-Live-Cam](https://github.com/hacksider/Deep-Live-Cam) | AI 도구 | real time face swap and one-click video deepfake with only a single image | 의견: 글쓰기, 개발, 리서치, 자동화 효율을 높일 수 있어 계속 지켜볼 만합니다. |<br/>
