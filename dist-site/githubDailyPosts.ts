...
export const githubDailyPosts: BlogPost[] = [
  {
    id: 'github-daily-2026-09-22',
    title: `今日值得看的 10 个 GitHub 开源项目｜2026-09-22`,
    summary: `白鹿 io 每日开源观察：带个人判断、项目地址、多语言速览，筛选值得关注的 AI 工具、效率工具和学习资源。`,
    content: `# 今日值得看的 10 个 GitHub 开源项目｜2026-09-22<br/>
<br/>
...
- 语言：TypeScript<br/>
- Stars：69,026<br/>
- 一句话：Never stop coding. Free MIT AI gateway: one endpoint, 359 providers (150+ free), 1200+ models Kimi, Claude, GPT, Gemini, GLM, DeepSeek, MiniMax. Works with Clau...<br/>
- 我的判断：我会优先关注这类项目，它可能直接改变写作、编程、整理资料和自动化工作的效率。<br/>
- 适合人群：适合想提升工作效率、做内容、写代码或研究 AI 应用的人。<br/>
<br/>
...
| 9 | [diegosouzapw/OmniRoute](https://github.com/diegosouzapw/OmniRoute) | AI Tools | Never stop coding. Free MIT AI gateway: one endpoint, 359 providers (150+ free), 1200+ mod... | My take: worth tracking because it may improve writing, coding, research, or automation workflows. |<br/>
...
| 9 | [diegosouzapw/OmniRoute](https://github.com/diegosouzapw/OmniRoute) | AIツール | Never stop coding. Free MIT AI gateway: one endpoint, 359 providers (150+ free), 1200+ mod... | 所感：文章作成、開発、調査、自動化の効率を上げる可能性があり、継続的に見たいプロジェクトです。 |<br/>
...
| 9 | [diegosouzapw/OmniRoute](https://github.com/diegosouzapw/OmniRoute) | AI 도구 | Never stop coding. Free MIT AI gateway: one endpoint, 359 providers (150+ free), 1200+ mod... | 의견: 글쓰기, 개발, 리서치, 자동화 효율을 높일 수 있어 계속 지켜볼 만합니다. |<br/>
