...
export const githubDailyPosts: BlogPost[] = [
  {
    id: 'github-daily-2026-04-25',
    title: `今日值得看的 10 个 GitHub 开源项目｜2026-04-25`,
    summary: `白鹿 io 每日开源观察：带个人判断、项目地址、多语言速览，筛选值得关注的 AI 工具、效率工具和学习资源。`,
    content: `# 今日值得看的 10 个 GitHub 开源项目｜2026-04-25<br/>
<br/>
...
- 适合人群：适合想提升工作效率、做内容、写代码或研究 AI 应用的人。<br/>
<br/>
### 8. [mem0ai/mem0](https://github.com/mem0ai/mem0)<br/>
<br/>
...
- 适合人群：适合想提升工作效率、做内容、写代码或研究 AI 应用的人。<br/>
<br/>
### 9. [bmad-code-org/BMAD-METHOD](https://github.com/bmad-code-org/BMAD-METHOD)<br/>
<br/>
...
| 8 | [mem0ai/mem0](https://github.com/mem0ai/mem0) | AI Tools | Universal memory layer for AI Agents | My take: worth tracking because it may improve writing, coding, research, or automation workflows. |<br/>
| 9 | [bmad-code-org/BMAD-METHOD](https://github.com/bmad-code-org/BMAD-METHOD) | AI Tools | Breakthrough Method for Agile Ai Driven Development | My take: worth tracking because it may improve writing, coding, research, or automation workflows. |<br/>
...
| 8 | [mem0ai/mem0](https://github.com/mem0ai/mem0) | AIツール | Universal memory layer for AI Agents | 所感：文章作成、開発、調査、自動化の効率を上げる可能性があり、継続的に見たいプロジェクトです。 |<br/>
| 9 | [bmad-code-org/BMAD-METHOD](https://github.com/bmad-code-org/BMAD-METHOD) | AIツール | Breakthrough Method for Agile Ai Driven Development | 所感：文章作成、開発、調査、自動化の効率を上げる可能性があり、継続的に見たいプロジェクトです。 |<br/>
...
| 8 | [mem0ai/mem0](https://github.com/mem0ai/mem0) | AI 도구 | Universal memory layer for AI Agents | 의견: 글쓰기, 개발, 리서치, 자동화 효율을 높일 수 있어 계속 지켜볼 만합니다. |<br/>
| 9 | [bmad-code-org/BMAD-METHOD](https://github.com/bmad-code-org/BMAD-METHOD) | AI 도구 | Breakthrough Method for Agile Ai Driven Development | 의견: 글쓰기, 개발, 리서치, 자동화 효율을 높일 수 있어 계속 지켜볼 만합니다. |<br/>
